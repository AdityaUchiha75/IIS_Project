...
def main():
    ...
    #-----------------CREAING THE AU DATAFRAME-----------------#

    ext_columns = mixed_prediction.aus.columns.tolist() +  mixed_prediction.emotions.columns.tolist() + ['input']

    #Column wise slice & dropping rows with NaN values (possibly cases where no face is detected or something else got misclassified as a face)
    ...
    #-----------------MERGING THE DATAFRAMES WITH RESPECT TO INPUR(IMAGES)-----------------#
