...
def visualizationExercise(furhat, emotion):
    # Visualization (1 minute)
    furhat.say(text="Now, let's enter a moment of visualization.")
    sleep(12)
    furhat.say(text="Picture a serene place in your mind. It could be a beach, a forest, or any place that brings you "
                    "peace.")
    sleep(12)
    ...
    visualizationResponse(furhat, emotion)
    # furhat.say(
    #     f"I understand you're feeling {emotion}. Embrace visualization, and let it guide you towards a {response} state.")
...
def gratitudeExercise(furhat):
    ...
    furhat.say(
        f"I understand you're feeling {emotion}. Embrace gratitude, and let it guide you towards a {response} state.")
...
def visualizationResponse(furhat, emotion):
    if emotion == "angry":
        furhat.say(
            "I see that you're angry. While in this visualization, acknowledge your anger and visualize letting it "
            "go. Picture your serene place absorbing any negative energy.")
        sleep(3)
        askForBreak()

    elif emotion == "happy":
        furhat.say(
            "Great to see you're feeling happy! In your visualization, amplify this happiness. Picture your serene "
            "place filled with joyful energy.")
        sleep(3)
        askForBreak()

    elif emotion == "sad":
        furhat.say(
            "I notice that you're feeling sad. During this visualization, allow the peaceful setting to envelop you "
            "with comfort. Visualize releasing any sadness with each breath.")
        sleep(3)
        askForBreak()

    elif emotion == "calm":
        furhat.say(
            "I sense that you're feeling calm. Use this calmness to deepen your visualization experience. Picture "
            "your serene place with heightened clarity and tranquility.")
        sleep(3)
        askForBreak()

    else:
        furhat.say(
            "I understand that emotions can be complex. Whatever you're feeling, allow gratitude to be a source of "
...
def gratitudeEmotionResponse(furhat, emotion):
    if emotion == "angry":
        furhat.say(
            "I see that you're Angry. I understand that anger can be challenging. Acknowledge it and allow gratitude "
            "to bring a sense of peace and positivity.")
        sleep(3)
        return "happy"

    elif emotion == "sad":
        furhat.say(
            "I see that you're Sad. Feeling sad is a natural part of life. Embrace gratitude to lift your spirits and "
            "find comfort in the positive aspects of your day.")
        sleep(3)
        return "calm/relaxed"

    elif emotion == "calm":
        furhat.say(
            "I see that you're calm. It's wonderful that you're feeling calm. Use this calmness to deepen your sense "
        ...
        furhat.say(
            "I see that you're happy. That's Fantastic! Embrace the joy you're feeling. Let gratitude amplify this "
            "happiness and create a positive ripple effect in your day.")
        sleep(3)
        return "calm/relaxed"
